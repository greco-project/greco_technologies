...
df = pd.read_csv('/home/local/RL-INSTITUT/inia.steinbach/rl-institut/04_Projekte/220_GRECO/03-Projektinhalte/AP4_High_Penetration_of_Photovoltaics/T4_2_Perovskit-Silicon/Data_Marko/RE%3a_AM-abh%c3%a4ngiger_Eenrgieertrag_von_Perowskit-Tandemsolarzellen/complete_dataset_colorado_filtered.csv',
                   sep=',', index_col=0)
...
module_params = {'gamma_ref': 2.4,                                            #todo: The diode ideality factor
...
df['temp']=0
celltemp = csys.pvsyst_celltemp(df['GHI'],
                                df['temp'],
                                df['wind speed'])
celltemp=0
